...
const struct _inv_weak_map_int mpu_accel_fs_map = {
...
const struct _inv_weak_map_int mpu_gyro_fs_map = {
...
const struct _inv_weak_map_float mpu_accel_unit_G_map = {
...
const struct _inv_weak_map_float mpu_gyro_unit_dps_map = {
...
const struct _inv_weak_map_float mpu_accel_unit_from_G_map = {
...
const struct _inv_weak_map_float mpu_gyro_unit_from_dps_map = {
...
const struct _inv_weak_map_int MPU9250_GBW_MAP = {
...
const struct _inv_weak_map_int MPU9250_ABW_MAP = {
...
const struct _inv_weak_map_int ICM20948_GBW_MAP = {
...
void _IMU_Destruct(inv_imu_handle _this) { INV_FREE(_this); }
bool _IMU_IsOpen(inv_imu_handle _this) { return _this->isOpen; }
